                ...
                for file_to_fix in files_to_fix:
                    if file_to_fix in files:
                        ...
                        with open(path, "wb") as f:
                            f.write(data.replace(text_to_replace, replace)
                                    .replace(text_to_replace.lower(), replace.lower()))
...
def image_magick_reproduce():
    ...
    image_magick_reproducer.reproduce("CVE-2017-12418", "4638252", r"C:\Users\User\Downloads\Memory-Leak-1_output_fpx_1501588084.95",
              "convert", "{PROGRAM} {SEEDFILE} {TMP_FILE}.fpx")
    image_magick_reproducer.reproduce("CVE-2017-11750", "1828667", r"C:\Users\User\Downloads\SEGV-0x000000000000_output_aai_1501399328.45",
              "convert", "{PROGRAM} {SEEDFILE} {TMP_FILE}.aai")
    image_magick_reproducer.reproduce("CVE-2017-11755", "cb71321", r"C:\Users\User\Downloads\Memory-Leak-21_output_picon_1501391824.23",
              "convert", "{PROGRAM} {SEEDFILE} {TMP_FILE}.picon")
    image_magick_reproducer.reproduce("CVE-2017-11751", "cb71321", r"C:\Users\User\Downloads\Memory-Leak-13_output_picon_1501390784.98",
              "convert", "{PROGRAM} {SEEDFILE} {TMP_FILE}.picon")
    image_magick_reproducer.reproduce("CVE-2017-9501", "e057809", r"C:\Users\User\Downloads\assertion-failed-in-LockSemaphoreInfo-semaphore295",
              "convert", "{PROGRAM} {SEEDFILE} {TMP_FILE}.png")
    image_magick_reproducer.reproduce("CVE-2017-11531", "c81594c", r"C:\Users\User\Downloads\memory-leak_output_histogram_WriteHISTOGRAMImage",
              "convert", "{PROGRAM} {SEEDFILE} {TMP_FILE}.histogram")
    image_magick_reproducer.reproduce("CVE-2017-11531", "e793eb2", r"C:\Users\User\Downloads\Memory-Leak-19_output_msl_1501504023.36",
              "convert", "{PROGRAM} {SEEDFILE} {TMP_FILE}.msl")
    image_magick_reproducer.reproduce("CVE-2017-11523", "a8f9c2a", r"C:\Users\User\Downloads\cpu-ReadTXTImage.txt",
              "convert", "{PROGRAM} {SEEDFILE} {TMP_FILE}.bmp")
    image_magick_reproducer.reproduce("CVE-2017-UNKNNOW#621", "8dd3ac4", r"C:\Users\User\Downloads\bad_free_in_RelinquishMagickMemory",
              "identify", "{PROGRAM} {SEEDFILE} {TMP_FILE}.bmp")
    image_magick_reproducer.reproduce("CVE-2017-UNKNNOW#592", "9fd10cf", r"C:\Users\User\Downloads\sample (1).gif",
              "convert", "{PROGRAM} {SEEDFILE} {TMP_FILE}.gif")
    image_magick_reproducer.reproduce("CVE-2017-9499", "7fd4194", r"C:\Users\User\Downloads\assertion-failed-in-SetPixelChannelAttributes-pixel-accessor695 (1)",
              "convert", "{PROGRAM} {SEEDFILE} {TMP_FILE}.png")
    ...
    image_magick_reproducer.reproduce("CVE-2017-11539", "36aad91", r"C:\Users\User\Downloads\memory-leak_output_art_ReadOnePNGImage",
              "convert", "{PROGRAM} {SEEDFILE} {TMP_FILE}.art")
    image_magick_reproducer.reproduce("CVE-2017-11533", "f0c29cc", r"C:\Users\User\Downloads\heap-buffer-overflow-READ-0x7fd806e82db2_output_uil_1500210468.72",
              "convert", "{PROGRAM} {SEEDFILE} {TMP_FILE}.uil")
    image_magick_reproducer.reproduce("CVE-2017-11753", "5095363", r"C:\Users\User\Downloads\heap-buffer-overflow-READ-0x0000006869f0_output_json_1501326140.06.fits",
              "convert", "{PROGRAM} {SEEDFILE} {TMP_FILE}.json")
    image_magick_reproducer.reproduce("CVE-2017-11753_V2", "ccc71c1", r"C:\Users\User\Downloads\heap-buffer-overflow-READ-0x0000006869f0_output_json_1501326140.06.fits",
              "convert", "{PROGRAM} {SEEDFILE} {TMP_FILE}.json")
    image_magick_reproducer.reproduce("CVE-2017-11310", "8ca3583", r"C:\Users\User\Downloads\read_user_chunk_callback.png",
              "identify ", "{PROGRAM} {SEEDFILE}")
    image_magick_reproducer.reproduce("CVE-2017-11446", "787ee25", r"C:\Users\User\Downloads\cpu-ReadPESImage",
              "identify", "{PROGRAM} {SEEDFILE}")
    image_magick_reproducer.reproduce("CVE-2017-11141", "cdafbc7", r"C:\Users\User\Downloads\ImageMagick-7.0.5-6-memory-exhaustion.MAT",
              "identify", "{PROGRAM} {SEEDFILE}")
    image_magick_reproducer.reproduce("CVE-2017-11535", "b8647f1", r"C:\Users\User\Downloads\heap-buffer-overflow-READ-0x7f58970bcdc4_output_ps_1500207243.43",
              "convert", "{PROGRAM} {SEEDFILE} {TMP_FILE}.ps")
    image_magick_reproducer.reproduce("CVE-2017-11537", "2bbc1b9", r"C:\Users\User\Downloads\FPE--0x7eff23c45e38_output_palm_1500208096.66",
              "convert", "{PROGRAM} {SEEDFILE} {TMP_FILE}.palm")
    image_magick_reproducer.reproduce("CVE-2017-11166", "31b842a", r"C:\Users\User\Downloads\ImageMagick-7.0.5-6-memory-exhaustion.XWD",
              "identify", "{PROGRAM} {SEEDFILE}")
    image_magick_reproducer.reproduce("CVE-2017-7606", "b218117", r"C:\Users\User\Downloads\00253-imagemagick-outsinde-unsigned-char (2)",
              "identify", "{PROGRAM} {SEEDFILE}")
    image_magick_reproducer.reproduce("CVE-2017-9500", "5d95b4c", r"C:\Users\User\Downloads\assertion-failed-in-ResetImageProfileIterator-profile1303_7.0.5-8_Q16",
              "convert", "{PROGRAM} {SEEDFILE} {TMP_FILE}.png")
    image_magick_reproducer.reproduce("CVE-2017-11170", "fbb5e1c", r"C:\Users\User\Downloads\ImageMagick-7.0.5-6-memory-exhaustion.VST",
              "identify", "{PROGRAM} {SEEDFILE}")
...
def jasper_reproduce():
    ...
    jasper_reproducer.reproduce("CVE-2017-6850", "e96fc4f",
                                r"C:\Users\User\Downloads\poc-master\poc-master\00124-jasper-nullptr-jp2_cdef_destroy",
                                "imginfo", "{PROGRAM} -f {SEEDFILE}")
...
def libtiff_reproduce():
    libtiff_reproducer = Reproducer(r"C:\vulnerabilities\libtiff_reproduce",
                                       r"C:\vulnerabilities\clean\tiff\libtiff",
                                       r"libtiff\tiff.sln",
                                       r"libtiff",
                                       r"libtiff\tools\Release",
                                       r"libtiff\libtiff\Release")
    libtiff_reproducer.reproduce("CVE-2017-5225", "5c080298d59efa53264d7248bbe3a04660db6ef7", r"C:\Users\User\Downloads\report_poc\poc.tiff",
                                    "tiffcp", "{PROGRAM} -p separate {SEEDFILE} {TMP_FILE}")
    libtiff_reproducer.reproduce("CVE-2016-9297", "30c9234c7fd0dd5e8b1e83ad44370c875a0270ed", r"C:\Users\User\Downloads\test000",
                                    "tiffinfo", "{PROGRAM} -i {SEEDFILE}")
    libtiff_reproducer.reproduce("CVE-2016-10095", "4d4fa0b68ae9ae038959ee4f69ebe288ec892f06", r"C:\Users\User\Downloads\00104-libtiff-stackoverflow-_TIFFVGetField",
                                    "tiffsplit", "{PROGRAM} {SEEDFILE}")
    libtiff_reproducer.reproduce("CVE-2016-10268", "5397a417e61258c69209904e652a1f409ec3b9df", r"C:\Users\User\Downloads\00068-libtiff-heapoverflow-_tiffWriteProc",
                                    "tiffcp", "{PROGRAM} -i {SEEDFILE} {TMP_FILE}")
    libtiff_reproducer.reproduce("CVE-2016-10269", "9a72a69e035ee70ff5c41541c8c61cd97990d018", r"C:\Users\User\Downloads\00074-libtiff-heapoverflow-TIFFFillStrip",
                                    "tiffcp", "{PROGRAM} -i {SEEDFILE} {TMP_FILE}")
    libtiff_reproducer.reproduce("CVE-2016-10270", "9657bbe3cdce4aaa90e07d50c1c70ae52da0ba6a", r"C:\Users\User\Downloads\poc-master\poc-master\00100-libtiff-heapoverflow-_TIFFFax3fillruns",
                                    "tiffcrop", "{PROGRAM} -i {SEEDFILE} {TMP_FILE}")
    libtiff_reproducer.reproduce("CVE-2016-10271", "9657bbe3cdce4aaa90e07d50c1c70ae52da0ba6a", r"C:\Users\User\Downloads\poc-master\poc-master\00102-libtiff-heapoverflow-_TIFFmemcpy",
                                    "tiffcrop", "{PROGRAM} -i {SEEDFILE} {TMP_FILE}")
    libtiff_reproducer.reproduce("CVE-2016-10093", "9657bbe3cdce4aaa90e07d50c1c70ae52da0ba6a", r"C:\Users\User\Downloads\poc-master\poc-master\00103-libtiff-heapoverflow-NeXTDecode",
                                    "tiffcrop", "{PROGRAM} -i {SEEDFILE} {TMP_FILE}")
    libtiff_reproducer.reproduce("CVE-2016-10272", "9657bbe3cdce4aaa90e07d50c1c70ae52da0ba6a", r"C:\Users\User\Downloads\poc-master\poc-master\00102-libtiff-heapoverflow-_TIFFmemcpy",
                                    "tiffcrop", "{PROGRAM} -i {SEEDFILE} {TMP_FILE}")
    libtiff_reproducer.reproduce("CVE-2016-10092", "b4b41925115059b49f97432bda0613411df2f686", r"C:\Users\User\Downloads\poc-master\poc-master\00067-libtiff-heapoverflow-tiffcp",
                                    "tiffcp", "{PROGRAM} -i {SEEDFILE} {TMP_FILE}")
    libtiff_reproducer.reproduce("CVE-2015-8784", "b18012dae552f85dcc5c57d3bf4e997a15b1cc1c", r"C:\Users\User\Downloads\libtiff5.tif",
                                    "tiffinfo", "{PROGRAM} -d {SEEDFILE}")
    libtiff_reproducer.reproduce("CVE-2015-8783", "aaab5c3c9d2a2c6984f23ccbc79702610439bc65", r"C:\Users\User\Downloads\broken_2.tif",
                                    "tiffinfo", "{PROGRAM} -d {SEEDFILE}")
    libtiff_reproducer.reproduce("CVE-2015-8683", "aaab5c3c9d2a2c6984f23ccbc79702610439bc65", r"C:\Users\User\Downloads\broken_2.tif",
                                    "tiffinfo", "{PROGRAM} -d {SEEDFILE}")
    libtiff_reproducer.reproduce("CVE-2014-9655", "0be02fe369e2fabf71856cd8c69d5659710d794d", r"C:\Users\User\Downloads\libtiff-cvs-1.tif",
                                    "tiffinfo", "{PROGRAM} -d {SEEDFILE}")
    libtiff_reproducer.reproduce("CVE-2014-9655_1", "40a5955cbf0df62b1f9e9bd7d9657b0070725d19", r"C:\Users\User\Downloads\libtiff-cvs-1.tif",
                                    "tiffinfo", "{PROGRAM} -d {SEEDFILE}")
    libtiff_reproducer.reproduce("CVE-2014-9655_2", "0be02fe369e2fabf71856cd8c69d5659710d794d", r"C:\Users\User\Downloads\libtiff-cvs-2.tif",
                                    "tiffinfo", "{PROGRAM} -d {SEEDFILE}")
    libtiff_reproducer.reproduce("CVE-2014-9655_3", "40a5955cbf0df62b1f9e9bd7d9657b0070725d19", r"C:\Users\User\Downloads\libtiff-cvs-2.tif",
                                    "tiffinfo", "{PROGRAM} -d {SEEDFILE}")
    libtiff_reproducer.reproduce("CVE-2014-9330", "662f74445b2fea2eeb759c6524661118aef567ca", r"C:\Users\User\Downloads\crash.bmp",
                                    "bmp2tiff", "{PROGRAM} {SEEDFILE} {TMP_FILE}")
    libtiff_reproducer.reproduce("CVE-2013-4243", "2f756ac2adc513c97b58144471a1a0887a2650ae", r"C:\Users\User\Downloads\008.gif",
                                    "gif2tiff", "{PROGRAM} {SEEDFILE} {TMP_FILE}")
    libtiff_reproducer.reproduce("CVE-2016-9453", "7399a6f13bd6f4d0dfb7b9d0a25fafa86caa9b50", r"C:\Users\User\Downloads\1 (1).tiff",
                                    "gif2tiff", "{PROGRAM} {SEEDFILE} {TMP_FILE}")
    libtiff_reproducer.reproduce("CVE-2016-9453_!", "a7abf0ba9044810d8d3104045e3bd840d1569d51", r"C:\Users\User\Downloads\test049",
                                    "tiffsplit", "{PROGRAM} {SEEDFILE}")
...
def imageworsener_reproduce():
    ...
    imageworsener_reproducer.reproduce("CVE-2017-9201", "dc49c807926b96e503bd7c0dec35119eecd6c6fe",
                                 r"C:\Users\User\Downloads\poc-master\poc-master\00278-imageworsener-fpe-outside-int",
    ...
    imageworsener_reproducer.reproduce("CVE-2017-9202", "dc49c807926b96e503bd7c0dec35119eecd6c6fe",
                                 r"C:\Users\User\Downloads\poc-master\poc-master\00279-imageworsener-fpe-outside-int_2",
                                 "imagew", "{PROGRAM} {SEEDFILE} {TMP_FILE} -outfmt bmp")
    imageworsener_reproducer.reproduce("CVE-2017-9203", "a4f247707f08e322f0b41e82c3e06e224240a654",
                                 r"C:\Users\User\Downloads\poc-master\poc-master\00280-imageworsener-oob-iw_channelinfo_out",
                                 "imagew", "{PROGRAM} {SEEDFILE} {TMP_FILE} -outfmt bmp")
    imageworsener_reproducer.reproduce("CVE-2017-9204", "b45cb1b665a14b0175b9cb1502ef7168e1fe0d5d",
                                 r"C:\Users\User\Downloads\poc-master\poc-master\00281-imageworsener-invalidread-iw_get_ui16le",
                                 "imagew", "{PROGRAM} {SEEDFILE} {TMP_FILE} -outfmt bmp")
    imageworsener_reproducer.reproduce("CVE-2017-9205", "b45cb1b665a14b0175b9cb1502ef7168e1fe0d5d",
                                 r"C:\Users\User\Downloads\poc-master\poc-master\00282-imageworsener-invalidread-iw_get_ui16be",
                                 "imagew", "{PROGRAM} {SEEDFILE} {TMP_FILE} -outfmt bmp")
    imageworsener_reproducer.reproduce("CVE-2017-9206", "b45cb1b665a14b0175b9cb1502ef7168e1fe0d5d",
                                 r"C:\Users\User\Downloads\poc-master\poc-master\00283-imageworsener-heapoverflow-iw_get_ui16le",
                                 "imagew", "{PROGRAM} {SEEDFILE} {TMP_FILE} -outfmt bmp")
    imageworsener_reproducer.reproduce("CVE-2017-9207", "b45cb1b665a14b0175b9cb1502ef7168e1fe0d5d",
                                 r"C:\Users\User\Downloads\poc-master\poc-master\00284-imageworsener-heapoverflow-iw_get_ui16be",
                                 "imagew", "{PROGRAM} {SEEDFILE} {TMP_FILE} -outfmt bmp")
    imageworsener_reproducer.reproduce("CVE-2017-9094", "a75fd48",
                                 r"C:\Users\User\Downloads\183df600-3a7c-11e7-8f6d-88b61e33bb08.jpg",
                                 "imagew", "{PROGRAM} {SEEDFILE} {TMP_FILE} -outfmt bmp")
    imageworsener_reproducer.reproduce("CVE-2017-9093", "62bfbfb",
                                 r"C:\Users\User\Downloads\9b1f87c4-3823-11e7-85d8-2136f4a9ad59.jpg",
                                 "imagew", "{PROGRAM} {SEEDFILE} {TMP_FILE} -outfmt bmp")
    imageworsener_reproducer.reproduce("CVE-2017-8327", "86564051db45b466e5f667111ce00b5eeedc8fb6",
                                 r"C:\Users\User\Downloads\poc-master\poc-master\00276-imageworsener-memallocfailure",
                                 "imagew", "{PROGRAM} {SEEDFILE} {TMP_FILE} -outfmt bmp")
    imageworsener_reproducer.reproduce("CVE-2017-8326", "a00183107d4b84bc8a714290e824ca9c68dac738",
                                 r"C:\Users\User\Downloads\poc-master\poc-master\00271-imageworsener-leftshift",
                                 "imagew", "{PROGRAM} {SEEDFILE} {TMP_FILE} -outfmt bmp")
    imageworsener_reproducer.reproduce("CVE-2017-8325", "86564051db45b466e5f667111ce00b5eeedc8fb6",
                                 r"C:\Users\User\Downloads\poc-master\poc-master\00269-imageworsener-heapoverflow-iw_process_cols_to_intermediate",
                                 "imagew", "{PROGRAM} {SEEDFILE} {TMP_FILE} -outfmt bmp")
    imageworsener_reproducer.reproduce("CVE-2017-7962", "ca3356eb49fee03e2eaf6b6aff826988c1122d93",
                                 r"C:\Users\User\Downloads\poc-master\poc-master\00270-imageworsener-FPE-iwgif_record_pixel",
                                 "imagew", "{PROGRAM} {SEEDFILE} {TMP_FILE} -outfmt bmp")
    imageworsener_reproducer.reproduce("CVE-2017-7940", "5fa4864",
                                 r"C:\Users\User\Downloads\topnm-memory-leak-in-imagew-cmd",
                                 "imagew", "{PROGRAM} {SEEDFILE} {TMP_FILE}.pnm")
    imageworsener_reproducer.reproduce("CVE-2017-7939", "bb321cf",
                                 r"C:\Users\User\Downloads\1071-stack-buffer-overflow-imagew-pnm",
                                 "imagew", "{PROGRAM} {SEEDFILE} {TMP_FILE}.png")
    imageworsener_reproducer.reproduce("CVE-2017-7624", "49912f8",
                                 r"C:\Users\User\Downloads\1048-memoryleak-imagew-cmd",
                                 "imagew", "{PROGRAM} {SEEDFILE} {TMP_FILE}.png")
    imageworsener_reproducer.reproduce("CVE-2017-7623", "f9c12fa",
                                 r"C:\Users\User\Downloads\1049-heap-buffer-overflow-imagew-miff",
                                 "imagew", "{PROGRAM} {SEEDFILE} {TMP_FILE}.png")
    imageworsener_reproducer.reproduce("CVE-2017-7454", "dc74009",
                                 r"C:\Users\User\Downloads\1111-heap-buffer-overslow-imagew-gif_223_5",
                                 "imagew", "{PROGRAM} {SEEDFILE} {TMP_FILE}.png")
    imageworsener_reproducer.reproduce("CVE-2017-7453", "dc74009",
                                 r"C:\Users\User\Downloads\1016-NULL-ptr-imagew-gif_223_5",
                                 "imagew", "{PROGRAM} {SEEDFILE} {TMP_FILE}.png")
    imageworsener_reproducer.reproduce("CVE-2017-7452", "4500070",
                                 r"C:\Users\User\Downloads\2712-NULL-ptr-imagew-bmp_419_2",
                                 "imagew", "{PROGRAM} {SEEDFILE} {TMP_FILE}.png")
